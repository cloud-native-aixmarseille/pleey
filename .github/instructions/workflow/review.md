...
- Flag missed factorization opportunities when the same structure or decision is repeated, especially redundant wrappers, pass-through branches, and frontend props that are identical at every call site.
