...
describe('PIN', () => {
  describe('constructor', () => {
    it('should create a PIN with valid 6-digit value', () => {
      const pin = createPinFixture({ value: '123456' });
  ...
  describe('getValue', () => {
    it('should return the PIN value', () => {
      const pin = createPinFixture({ value: '987654' });
  ...
  describe('equals', () => {
    it('should return true for equal PINs', () => {
      const pin1 = createPinFixture({ value: '123456' });
      const pin2 = createPinFixture({ value: '123456' });
      expect(pin1.equals(pin2)).toBe(true);
    });

    it('should return false for different PINs', () => {
      const pin1 = createPinFixture({ value: '123456' });
      const pin2 = createPinFixture({ value: '654321' });
      expect(pin1.equals(pin2)).toBe(false);
    });

    it('should be symmetric', () => {
      const pin1 = createPinFixture({ value: '111111' });
      const pin2 = createPinFixture({ value: '111111' });
