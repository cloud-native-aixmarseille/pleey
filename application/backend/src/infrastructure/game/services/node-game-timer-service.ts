 ...
 * Manages result reveal timers for game sessions.
 */
@Injectable()
export class NodeGameTimerService implements GameTimerService {
  ...
  setResultRevealTimer(pin: GameSessionPin, delayMs: number, callback: TimerCallback): void {
    // Clear existing timer if any
    this.clearResultRevealTimer(pin);
  ...
  clearResultRevealTimer(pin: GameSessionPin): void {
