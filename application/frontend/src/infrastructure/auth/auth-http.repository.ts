...
import { fetchClient } from "../shared/http/api/openapiClient";
import { resolveAuthErrorKey } from "../../domains/auth/utils/resolve-auth-error";
import { castRequestBody } from "../shared/http/api/castRequestBody";
import {
  isAuthResponsePayload,
  isUserPayload,
} from "../../domains/auth/utils/auth-response.guard";
