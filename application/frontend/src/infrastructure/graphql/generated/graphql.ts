...
export type ListPartiesQuery = { listParties: { totalCount: number, overallCount: number, page: number, pageSize: number, totalPages: number, items: Array<{ partyId: number, gameId: number, pin: string, status: PartyStatus, role: PartyRole, createdAt: string }> } };
...
export type CreatePredictionFromImportManagementMutation = { createPredictionFromImport: { predictionId: number, promptCount: number } };
...
export type CreateQuizFromImportManagementMutation = { createQuizFromImport: { quizId: number, questionCount: number } };
...
export type AddOrganizationMemberMutation = { addOrganizationMember: { id: number, organizationId: number, userId: number, username: string, role: OrganizationRole, joinedAt: string } };
...
export type OrganizationMembersQuery = { organizationMembers: { totalCount: number, overallCount: number, page: number, pageSize: number, totalPages: number, items: Array<{ id: number, organizationId: number, userId: number, username: string, role: OrganizationRole, joinedAt: string }> } };
...
export type WorkspaceOrganizationsQuery = { myOrganizations: { totalCount: number, overallCount: number, page: number, pageSize: number, totalPages: number, items: Array<{ id: number, name: string, description: string | null, createdAt: string, updatedAt: string, role: OrganizationRole | null }> } };
...
export type UpdateOrganizationMemberRoleMutation = { updateOrganizationMemberRole: { id: number, organizationId: number, userId: number, username: string, role: OrganizationRole, joinedAt: string } };
...
export type WorkspaceProjectsByOrganizationQuery = { organizationProjects: { totalCount: number, overallCount: number, page: number, pageSize: number, totalPages: number, items: Array<{ id: number, name: string, description: string | null, organizationId: number, createdAt: string }> } };
...
export const RemoveOrganizationMemberDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveOrganizationMember"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"memberId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeOrganizationMember"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"memberId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"memberId"}}}]}]}}]} as unknown as DocumentNode<RemoveOrganizationMemberMutation, RemoveOrganizationMemberMutationVariables>;
export const UpdateOrganizationMemberRoleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateOrganizationMemberRole"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"memberId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateOrganizationMemberRoleInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateOrganizationMemberRole"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"memberId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"memberId"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"organizationId"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"role"}},{"kind":"Field","name":{"kind":"Name","value":"joinedAt"}}]}}]}}]} as unknown as DocumentNode<UpdateOrganizationMemberRoleMutation, UpdateOrganizationMemberRoleMutationVariables>;
