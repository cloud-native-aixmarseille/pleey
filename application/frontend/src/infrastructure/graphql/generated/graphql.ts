...
export type CreateOrganizationMutation = { createOrganization: { id: string, name: string, description: string | null, createdAt: string, updatedAt: string, role: OrganizationRole | null, defaultPartySettings: { allowOptionChangeAfterVoting: boolean, randomizeOptionOrder: boolean, randomizeStageOrder: boolean } | null } };
...
export type WorkspaceOrganizationsQuery = { myOrganizations: { totalCount: number, overallCount: number, page: number, pageSize: number, totalPages: number, items: Array<{ id: string, name: string, description: string | null, createdAt: string, updatedAt: string, role: OrganizationRole | null, defaultPartySettings: { allowOptionChangeAfterVoting: boolean, randomizeOptionOrder: boolean, randomizeStageOrder: boolean } | null }> } };
...
export type UpdateOrganizationMutation = { updateOrganization: { id: string, name: string, description: string | null, createdAt: string, updatedAt: string, role: OrganizationRole | null, defaultPartySettings: { allowOptionChangeAfterVoting: boolean, randomizeOptionOrder: boolean, randomizeStageOrder: boolean } | null } };
...
export type CreateProjectMutation = { createProject: { id: string, name: string, description: string | null, organizationId: string, createdAt: string, defaultPartySettings: { allowOptionChangeAfterVoting: boolean, randomizeOptionOrder: boolean, randomizeStageOrder: boolean } | null } };
...
export type UpdateProjectMutation = { updateProject: { id: string, name: string, description: string | null, organizationId: string, createdAt: string, defaultPartySettings: { allowOptionChangeAfterVoting: boolean, randomizeOptionOrder: boolean, randomizeStageOrder: boolean } | null } };
