export const gamePartyPlayerFr = {
  game: {
    party: {
      player: {
        route: {
          ...
          runtimeRewindStageToast:
            "L'hôte a ramené la partie à la manche précédente. Les réponses et points rembobinés ont été effacés.",
          runtimeRewindPartyToast:
            "L'hôte a renvoyé la partie au lobby. Les manches jouées ont été réinitialisées pour tout le monde.",
          hostMissing: "Aucun hôte n'est connecté à cette partie pour le moment.",
