    ...
    party: {
      settings: {
        ...
        allowJoiningAfterStartDescription:
          'Les nouveaux joueurs peuvent rejoindre même si une session est déjà en cours.',
      ...
      route: {
        ...
        stageResultsStandingsTitle: 'Classement en direct',
        stageResultsRankChangeUp: '+{{count}} place(s)',
        stageResultsRankChangeDown: '-{{count}} place(s)',
        stageResultsRankChangeSame: 'Maintien',
        stageResultsRankChangeNew: 'Nouveau',
        youBadge: 'Vous',
