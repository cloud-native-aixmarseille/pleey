        ...
        element: (
          <PatienceRouteProvider>
            <PartyLobbyScreen
              ...
              resolvePartyLobbyRoute={(partyId) => this.partyRouteService.resolvePartyLobbyRoute(partyId)}
              resolvePartyLeaderboardRoute={(partyId) => this.partyRouteService.resolvePartyLeaderboardRoute(partyId)}
              ...
              resolvePartyAbsoluteUrl={(pin) => this.partyRouteService.resolveJoinPartyAbsoluteUrl(pin)}
            />
          </PatienceRouteProvider>
        ),
      },
