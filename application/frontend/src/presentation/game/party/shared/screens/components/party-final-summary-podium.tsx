...
import { MotionPodiumRise } from '../../../../../shared/ui/motion/motion-primitives';
import {
...
function renderDesktopPodiumEntry(
  ...
  const entryDelay = rank === 2 ? 2.8 : rank === 3 ? 3.4 : 4.2;

  return (
    <MotionPodiumRise delay={entryDelay} key={toPartyFinalSummaryPlayerKey(player)}>
...
function renderMobileWinnerEntry(
  ...
  return (
    <MotionPodiumRise delay={3.4} key={`mobile-winner-${toPartyFinalSummaryPlayerKey(player)}`}>
