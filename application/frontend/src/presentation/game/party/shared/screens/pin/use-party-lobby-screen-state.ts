...
import { usePartyLobbyHostRuntime } from './host/use-party-lobby-host-runtime';
import { usePartyLobbyJoinSession } from './player/use-party-lobby-join-session';
import { usePartyLobbyPlayerSession } from './player/use-party-lobby-player-session';
import { PartyLobbyRuntimeRedirectResolver } from './shared/party-lobby-runtime-redirect-resolver';
import { resolvePartyLobbyScreenViewModel } from './shared/party-lobby-screen-view-model';
import { usePartyLobbyRouteContext } from './shared/use-party-lobby-route-context';
...
export function usePartyLobbyScreenState({
  ...
  const { getErrorByPartyId, getPartyByPartyId, getRuntimeNoticeByPartyId, observePartyById } =
    useParty();
  const {
  ...
  }, [currentPlayer, isCurrentUserHost, runtimeNotice]);
