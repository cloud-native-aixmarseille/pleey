export const homeEn = {
  home: {
    ...
    features: {
      eyebrow: 'Built for live events',
      items: [
        {
          label: 'Real-time quizzes',
          description: 'Timed question rounds with instant scoring and live leaderboards.',
        },
        {
          label: 'Audience predictions',
          description: 'Let the crowd forecast outcomes before you reveal the truth on stage.',
        },
        {
