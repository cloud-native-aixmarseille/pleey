...
import { AuthFramedAvatar, AuthProfileIdentityPanel } from '../shared/components/auth-shell-primitives';
...
export function ProfileIdentitySection({ isRegenerating, onRegenerateAvatar, user }: ProfileIdentitySectionProps) {
  ...
  return (
    <AuthProfileIdentityPanel>
      ...
      <Button disabled={isRegenerating} intent="secondary" onClick={() => void onRegenerateAvatar()}>
        {isRegenerating
