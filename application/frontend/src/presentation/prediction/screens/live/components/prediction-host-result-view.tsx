...
export function PredictionHostResultView({
  stage,
  actionResult,
  resultDistribution,
}: HostResultViewProps) {
  ...
  return (
    <ResultRevealAnimation>
      <div style={resultStageContainerStyle} data-testid="prediction-host-result-layout">
              ...
              <div style={createDistributionBarStyle(index, item.actionPercent, item.isCorrect)}>
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.25rem' }}>
                  ...
                  <span style={distributionCountStyle}>
                    ({t('prediction.runtime.voteCount', { count: String(item.actionCount) })})
                  </span>
                </div>
              </div>
