...
export function PredictionPlayerStageView({
  stage,
  resolvedActions,
  actionSubmitted,
  isPaused,
  ...
  return (
    <div style={playerStageContainerStyle}>
      ...
      {actionSubmitted ? (
        <StatusBanner tone="success">{t('prediction.runtime.responseLocked')}</StatusBanner>
      ) : null}
    </div>
  );
}
