  ...
  dashboard: {
    ...
    games: {
      ...
      createParty: {
        ...
        subtitle: 'Choisissez comment {{game}} doit se jouer pour cette partie.',
        defaultModeBadge: 'Mode par defaut',
        customModeBadge: 'Mode personnalise',
        playModeHeading: 'Mode de jeu',
        playModeDescription:
