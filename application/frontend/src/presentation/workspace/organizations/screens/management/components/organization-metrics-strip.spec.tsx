...
describe('OrganizationMetricsStrip', () => {
  it('renders the empty message when dashboard is null', () => {
    ...
    // Assert
    expect(screen.getByText('organization.management.stats.empty')).toBeInTheDocument();
  });
  ...
  it('renders metric labels using translation keys', () => {
    ...
    // Assert
    expect(screen.getByText('organization.management.stats.totalGames')).toBeInTheDocument();
    expect(screen.getByText('organization.management.stats.totalProjects')).toBeInTheDocument();
    expect(screen.getByText('organization.management.stats.totalMembers')).toBeInTheDocument();
  });
});
