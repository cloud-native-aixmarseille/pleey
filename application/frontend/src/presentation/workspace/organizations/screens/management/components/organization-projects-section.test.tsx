  ...
  it('renders the section content and delegates create/edit/remove actions', async () => {
    ...
    renderWithProviders(
      <OrganizationProjectsSection
        ...
        projects={[project, { ...project, id: 12, name: 'Backup event' }]}
    ...
    expect(onEditProject).toHaveBeenCalledWith(expect.objectContaining({ id: 11 }));
    expect(onRemoveProject).toHaveBeenCalledWith(expect.objectContaining({ id: 11 }));
  });
