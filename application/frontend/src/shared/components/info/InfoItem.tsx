...
import { withAlpha } from "../../ui/utils/color";
import { type IconSource, type IconTone, renderIconNode } from "../../ui/icons";

type InfoItemTone = "primary" | "secondary" | "neutral";
...
/**
 * Reusable Info Item component aligned with the shared design system.
 * Presents an icon with descriptive label/value pair using theme tokens.
 */
