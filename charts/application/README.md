...
| valkey.livenessProbe.initialDelaySeconds                             | int    | `10`                                                                        |             |
| valkey.livenessProbe.periodSeconds                                   | int    | `30`                                                                        |             |
| valkey.livenessProbe.tcpSocket.port                                  | int    | `6379`                                                                      |             |
| valkey.livenessProbe.timeoutSeconds                                  | int    | `5`                                                                         |             |
...
| valkey.readinessProbe.initialDelaySeconds                            | int    | `5`                                                                         |             |
| valkey.readinessProbe.periodSeconds                                  | int    | `10`                                                                        |             |
| valkey.readinessProbe.tcpSocket.port                                 | int    | `6379`                                                                      |             |
| valkey.readinessProbe.timeoutSeconds                                 | int    | `5`                                                                         |             |
