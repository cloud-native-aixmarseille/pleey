        ...
        <Card className="p-6 mb-6 animate-slide-down">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-4">
            <div className="flex items-center gap-3">
              <div className="glass-effect rounded-2xl px-4 py-2 border border-white/20">
          ...
          {/* Progress bar */}
          <div className="relative w-full bg-dark-700 rounded-full h-5 overflow-hidden border-2 border-dark-600">
            <div
              className={`
