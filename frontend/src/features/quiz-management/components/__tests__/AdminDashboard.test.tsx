...
describe('AdminDashboard', () => {
  const mockQuizzes = [
    { id: 1, title: 'Quiz 1', description: 'Description 1', created_by: 1, created_at: '2024-01-01', question_count: 3, is_active: true },
    { id: 2, title: 'Quiz 2', description: 'Description 2', created_by: 1, created_at: '2024-01-02', question_count: 5, is_active: false }
  ];
  ...
  it('should render admin dashboard with title', () => {
    ...
    render(<AdminDashboard quizzes={[]} {...mockHandlers} onDeleteQuiz={vi.fn()} />);
  ...
  render(<AdminDashboard quizzes={mockQuizzes} {...mockHandlers} onDeleteQuiz={vi.fn()} />);
