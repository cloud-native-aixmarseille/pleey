  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'neon': '0 0 5px theme(colors.primary.400), 0 0 20px theme(colors.primary.500), 0 0 40px theme(colors.primary.600)',
        'neon-secondary': '0 0 5px theme(colors.secondary.400), 0 0 20px theme(colors.secondary.500), 0 0 40px theme(colors.secondary.600)',
        'neon-accent': '0 0 5px theme(colors.accent.400), 0 0 20px theme(colors.accent.500), 0 0 40px theme(colors.accent.600)',
